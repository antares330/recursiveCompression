...
def runTest():
    ...
    # this is trying to fix the trash we created during initialization
    #test_df = test_df.transpose(copy=False)

    # doesn't work because the dataframe is trash (not initialized correctly)
    #test_df.drop(test_df[len(test_df.value) < 4].index)
